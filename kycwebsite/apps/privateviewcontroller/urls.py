...
urlpatterns = [
    ...
    path(r'admin-dashboard/add/juniormember/', views.add_junior_member, name="addjuniormember"),
    ...
    path(r'admin-dashboard/edit/member/<int:index>', views.edit_member, name="editmember"),
    ...
    path(r'admin-dashboard/remove/image/<int:index>', views.remove_image, name="removeimage")
]
