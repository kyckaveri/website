...
from ..publicviewcontroller.models import (
    Position,
    JuniorPosition,
    KYCMember,
    KYCJuniorMember,
...
def login_error(request):
    context = {"message": "Sorry wrong username/password"}
...
def admin_dashboard(request, message=None):
    ...
    images = [
        {"name": i.name, "image_url": i.image_url, "index": i.index}
    ...
    context = {
        ...
        "members": [
            {"INDEX": index, "MEMBER_NAME": member.name}
            for index, member in enumerate(members)
        ],
        "junior_members": [
            {"INDEX": index, "MEMBER_NAME": member.name}
            for index, member in enumerate(junior_members)
        ],
        "projects": [
            {
                "INDEX": index,
...
def add_member(request):
    ...
    try:
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": f"Error creating new member: {str(position)} {position_name}"},
            )
        )
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Created new member: {name}"},
        )
    )
...
def add_junior_member(request):
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Created new junior member: {name}"},
        )
    )
...
def remove_member(request, index):
    ...
    try:
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": "Error removing member"},
            )
        )
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Removed member: {member.name}"},
        )
    )
...
def edit_member(request, index=None):
    ...
    if index is None:
        try:
            ...
            return HttpResponseRedirect(
                reverse(
                    "privateviewcontroller:admindashboard",
                    kwargs={"message": "Error editing member"},
                )
            )

        member = (
            KYCMember.objects.all().filter(deleted=False).filter(name=original).first()
        )
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": f"Edited member: {member.name}"},
            )
        )
    ...
    context = {
        "member": {"name": member.name, "position": member.position.position_name},
        "positions": [
            position.position_name
            for position in Position.objects.all().order_by("importance")
        ],
...
def add_project(request):
    ...
    try:
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": "Error creating new project"},
            )
        )
    except ValueError:
        return HttpResponseRedirect(
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Created new project: {project_name}"},
        )
    )
    ...
    if index is None:
        try:
            ...
            return HttpResponseRedirect(
                reverse(
                    "privateviewcontroller:admindashboard",
                    kwargs={"message": "Error editing project"},
                )
            )
        except ValueError:
            return HttpResponseRedirect(
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": f"Edited project: {project_name}"},
            )
        )
...
def remove_project(request, index):
    ...
    try:
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": "Error removing project"},
            )
        )
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Removed project: {project.project_name}"},
        )
    )
...
def add_image(request):
    ...
    try:
        ...
        return HttpResponseRedirect(
            reverse(
                "privateviewcontroller:admindashboard",
                kwargs={"message": "Error adding new image"},
            )
        )
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Added new image: {name}"},
        )
    )
...
def remove_image(request, index):
    ...
    image = (
        CarouselImage.objects.all().filter(deleted=False).filter(index=index).first()
    )
    image.deleted = True
    image.save()
    ...
    return HttpResponseRedirect(
        reverse(
            "privateviewcontroller:admindashboard",
            kwargs={"message": f"Removed image: {image.name}"},
        )
    )
